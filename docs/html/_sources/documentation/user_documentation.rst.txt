...
A minimal data set (in BIDS format) can be downloaded `here <https://gricad-gitlab.univ-grenoble-alpes.fr/mia/mia_data_users>`__ to allow users to quickly start using and testing Mia.
