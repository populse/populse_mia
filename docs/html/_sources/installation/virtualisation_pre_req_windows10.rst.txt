...
Pre-requirements of windows installations are the same for `windows host installation in user mode <https://populse.github.io/populse_mia/html/installation/host_pre_req_windows10.html>`. But you can avoid numpy and PyQt5 install commands since they will be managed while installing the mia project in on ubuntu.

Once pre-requirements are aquired, you will need installing Wsl2 to host a virtual machine of ubuntu to install mia.
